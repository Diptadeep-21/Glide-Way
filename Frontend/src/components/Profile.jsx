...
const Profile = () => {
    ...
    useEffect(() => {
        ...
        if (token) {
            axios.get(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/users/me`, {
    ...
    const handleSave = async () => {
        ...
        try {
            const res = await axios.put(`${import.meta.env.VITE_API_BASE_URL || 'http://localhost:5000'}/api/users/me`, payload, {
                headers: { Authorization: `Bearer ${token}` }
            });
